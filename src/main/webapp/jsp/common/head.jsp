...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <%--<p><span>下午好！</span><span style="color: #fff21b"> <%= org.apache.commons.lang.StringEscapeUtils.escapeHtml(userSession.getUserName()) %></span> , 欢迎你！</p>
--%>
...
<!--时间-->
    <section class="publicTime">
        <span id="time">2024年5月20日 11:11  星期一</span>
 ...
 <section class="publicMian ">
     ...
     <%--将来自请求头部的 Referer 信息直接嵌入到 HTML 中，而没有进行适当的过滤和转义-->
