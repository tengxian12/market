...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/jsp/bill.do">
              ...
              <%-- 使用JSTL的<c:out>标签来对输出进行HTML编码,会自动将特殊字符转换为它们的HTML实体，从而防止XSS攻击 --%>
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="billCode">订单编码：</label>
                    <%--label for="billCode"><?php echo htmlspecialchars("订单编码："); ?></label--%>
                    <input type="text" name="billCode" id="billCode" value="${bill.billCode }" readonly="readonly"> 
                </div>
                <div>
                    <%--label for="productName">商品名称：</label--%>
                    <label for="productName"><?php echo htmlspecialchars("商品名称："); ?></label>
